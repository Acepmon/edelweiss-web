    ...
    <div class="container-fluid">
        ...
        <div class="shop">
            <div class="grid-layout grid-5-columns grid-loaded" data-item="grid-item" style="margin: 0px -20px -20px 0px; position: relative; height: 1200.88px;">
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 378.594px; top: 0px;">
                    <div class="product">
                        <div class="product-image">
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 757.188px; top: 0px;">
                    <div class="product">
                        <div class="product-image">
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 1135.78px; top: 0px;">
                    <div class="product">
                        <div class="product-image">
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 1514.38px; top: 0px;">
                    <div class="product">
                        <div class="product-image">
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 0px; top: 600.438px;">
                    <div class="product">
                        <div class="product-image">
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 378.594px; top: 600.438px;">
                    <div class="product">
                        <div class="product-image">
                            <a href="#"><img alt="Shop product image!" src="images/shop/products/9.jpg">
                            </a>
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 757.188px; top: 600.438px;">
                    <div class="product">
                        <div class="product-image">
                            <a href="#"><img alt="Shop product image!" src="images/shop/products/10.jpg">
                            </a>
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 1135.78px; top: 600.438px;">
                    <div class="product">
                        <div class="product-image">
                            <a href="#"><img alt="Shop product image!" src="images/shop/products/11.jpg">
                            </a>
                ...
                <div class="grid-item" style="padding: 0px 20px 20px 0px; position: absolute; left: 1514.38px; top: 600.438px;">
                    <div class="product">
                        <div class="product-image">
